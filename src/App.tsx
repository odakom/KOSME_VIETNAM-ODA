...
function ClientPortal({ data, setData, refreshData, isLoading, error }: { data: AppData; setData: (data: AppData) => void; refreshData: () => Promise<void>; isLoading: boolean; error: string }) {
  ...
  return (
    ...
    >
      ...
      <AdminPage page="dashboard" data={data} setData={setData} />
    </Layout>
  );
}
...
export default function App() {
  ...
  if (location.pathname === "/client" || location.pathname.startsWith("/client/")) return <ClientPortal data={data} setData={setData} refreshData={refreshFromSupabase} isLoading={isSupabaseLoading} error={supabaseError} />;
